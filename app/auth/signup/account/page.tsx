    ...
    <div className="overflow-hidden bg-white w-full h-screen flex flex-col">
      ...
      <div className="flex flex-col justify-center p-5 w-full">
        ...
        <div className="mt-12 w-full">
          ...
          <div className="mt-4 w-full">
            ...
            <div className="flex gap-3 items-center p-3 w-full bg-white border-b border-gray-200">
              ...
              <Button
                ...
                className="flex gap-2.5 justify-center items-center px-3.5 py-2.5 text-xs font-bold text-center text-white bg-primary rounded-md hover:bg-primary/90 h-[34px] flex-shrink-0"
              >
                중복확인
              </Button>
            </div>
            ...
            {isUsernameChecked && (
              <div className="flex flex-col gap-1.5 items-start px-3 mt-2 w-full text-xs font-medium leading-6 text-green-600 justify-center">
                <div className="flex gap-1.5 items-center">
                  <Check className="object-contain shrink-0 self-stretch my-auto w-4 aspect-square" />
          ...
          <div className="mt-4 w-full text-xs font-medium leading-6">
            <div className="flex gap-1.5 items-center px-3 w-full text-green-600">
              <Check className="object-contain shrink-0 self-stretch my-auto w-4 aspect-square" />
              <div className="self-stretch my-auto text-green-600">
                숫자, 영문 대소문자, 특수문자가 포함되어 있습니다.
              </div>
            </div>
            <div className="flex gap-1.5 items-center px-3 w-full text-neutral-400">
              <Check className="object-contain shrink-0 self-stretch my-auto w-4 aspect-square" />
      ...
      <div className="px-5 pt-5 pb-10 w-full text-lg font-bold text-center text-white whitespace-nowrap">
        <Button
          onClick={handleNext}
          className="flex gap-2.5 justify-center items-center p-4 w-full rounded-lg bg-primary hover:bg-primary/90 text-white h-[53px]"
        >
          회원가입
        </Button>
      </div>
