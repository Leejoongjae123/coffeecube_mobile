...
import { TabKey, StatusRow } from "../types";

const dailyCollectionData: StatusRow[] = [
...
const monthlyCollectionData: StatusRow[] = [
...
export default function StatusClient() {
  ...
  const data = activeTab === 'daily' ? dailyCollectionData : monthlyCollectionData;
  ...
  return (
    <div className="min-h-screen text-center bg-white w-full">
      <div className="flex px-5 py-4 text-lg font-medium text-neutral-700 h-[60px] sticky top-0 bg-white z-10 border-b border-gray-100">
        <div className="self-stretch my-auto text-neutral-700 w-full">커피박 수거량 조회</div>
      </div>
